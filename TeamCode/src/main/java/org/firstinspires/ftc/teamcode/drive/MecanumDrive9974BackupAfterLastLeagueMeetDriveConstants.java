 ...
 */
@Config
public class MecanumDrive9974BackupAfterLastLeagueMeetDriveConstants extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(8, 0, 0);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(7, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.36363636;
    ...
    public MecanumDrive9974BackupAfterLastLeagueMeetDriveConstants(HardwareMap hardwareMap) {
...
*/
        ...
        //adding Encoder Motors here to extract values easily.
