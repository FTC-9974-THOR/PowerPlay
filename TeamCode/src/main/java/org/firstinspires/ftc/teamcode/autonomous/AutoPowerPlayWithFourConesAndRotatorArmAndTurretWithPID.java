...
@Disabled
public class AutoPowerPlayWithFourConesAndRotatorArmAndTurretWithPID extends LinearOpMode {
    ...
    public static  double xValueForwardTowardsXConeStackLeftClaw1 = -57.9; //Reduced, orig is -58.1
    ...
    public static  double xValueForChannelLeft = -32.25; //37 // 0.33
    ...
    public static double MAX_VEL_OVERRIDE_FAST = DriveConstants.MAX_VEL*0.80; //0.7
    public static  double MAX_ACCEL_OVERRIDE_FAST = DriveConstants.MAX_ACCEL*0.80; //0.7
    public static double MAX_VEL_OVERRIDE_SLOW = DriveConstants.MAX_VEL*0.60; //0.7
    public static  double MAX_ACCEL_OVERRIDE_SLOW = DriveConstants.MAX_ACCEL*0.60; //0.7
    public AutoPowerPlayWithFourConesAndRotatorArmAndTurretWithPID(int TeamColor, boolean SlideToSide) {
        super();
        teamColor = TeamColor;
...
/*
  ...
  */
        ...
        double timeToWaitBeforeMovingAtStart = 300;
                            ...
                            switch(counterForAutoCycle)
                            {
                                case 1:
                                    ...
                                    if (teamColor < 0) {
                                        ...
                                        turret.update();
                                        rotatingArm.setRotatorArmPositionRaw(rotatingArm.ROTATOR_RIGHT_45);
                                    } else {
                                        turret.turretGoLeft();
                                        turret.update();
                                        rotatingArm.setRotatorArmPositionRaw(rotatingArm.ROTATOR_LEFT_45);
                                    }
                                    break;
                                case 2:
                                    //drive.followTrajectoryAsync(backTowardsThirdPole);
