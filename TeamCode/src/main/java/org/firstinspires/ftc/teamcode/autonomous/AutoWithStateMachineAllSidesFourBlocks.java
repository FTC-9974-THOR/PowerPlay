...
@Disabled
public class AutoWithStateMachineAllSidesFourBlocks extends LinearOpMode {
...
// region STATES FOR LEVEL MIDDLE
    ...
    public AutoWithStateMachineAllSidesFourBlocks(int TeamColor, boolean SlideToSide) {
        super();
        teamColor = TeamColor;
