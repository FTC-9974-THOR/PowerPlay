...
*/
            ...
            if (gamepad2.b) {
                drive.leftWheel.setPosition(0.25);
                drive.rightWheel.setPosition(0.5);

            }

            if (gamepad2.x) {
                drive.leftWheel.setPosition(0.3);
                drive.rightWheel.setPosition(0.25);
            }
            ...
            if(gamepad2.left_stick_y < 0.0) {
                drive.SlideMotor.setPower(gamepad2.left_stick_y*-0.4);
            }
...
// Show the potentiometer’s voltage in telemetry
            ...
            telemetry.addData("PositionOfSlide", drive.SlideMotor.getCurrentPosition());
            telemetry.addData("servoPosition", servoPosition);
            telemetry.addData("servoturretPosition", servoPositionTurret);
            telemetry.addData("servoPositionRight", drive.rightWheel.getPosition());
            telemetry.addData("servoPositionLeft", drive.leftWheel.getPosition());
